...
internal static unsafe class BufferManager
{
	...
	private static readonly Stack<ReferenceCounter> ReferenceCounterPool = new(1024);

	private static readonly Dictionary<int, Stack<IntPtr>> BufferPools = new();

	private static readonly Dictionary<IntPtr, ReferenceCounter> ReferenceCounters = new(1024);

	private static readonly FreeFn FreeFunctionPin = Free;
