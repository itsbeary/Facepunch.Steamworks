...
public class SteamScreenshots : SteamClientClass<SteamScreenshots>
{
	...
	///         If the hooking is enabled, then the <see cref="OnScreenshotRequested" /> callback will be sent if the user
	///         presses the hotkey or
	///         when TriggerScreenshot is called, and then the game is expected to call
	///         <see cref="WriteScreenshot(byte[], int, int)" /> or <see cref="AddScreenshot(string, string, int, int)" /> in
	///         response.
	///     </para>
	/// </summary>
