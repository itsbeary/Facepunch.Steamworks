...
{
	/// <summary>
	///     Invoked when a <see cref="SteamId" /> wants to send the current user a message. You should respond by calling
	///     <see cref="AcceptP2PSessionWithUser(SteamId)" />
	...
	///     Reads in a packet that has been sent from another user via <c>SendP2PPacket</c>.
	/// </summary>
	public static unsafe bool ReadP2PPacket( byte* buffer, uint cbuf, ref uint size, ref SteamId steamid,
		int channel = 0 )
	{
