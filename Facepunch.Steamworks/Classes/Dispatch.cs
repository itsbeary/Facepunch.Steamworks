...
public static class Dispatch
{
	...
	/// </summary>
	private static readonly List<Action<IntPtr>> actionsToCall = new();

	private static Dictionary<ulong, ResultCallback> ResultCallbacks = new();

	private static readonly Dictionary<CallbackType, List<Callback>> Callbacks = new();
