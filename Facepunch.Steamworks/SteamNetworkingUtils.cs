...
public class SteamNetworkingUtils : SteamSharedClass<SteamNetworkingUtils>
{
	...
	private static readonly ConcurrentQueue<DebugMessage> debugMessages = new();
	...
	internal static unsafe int GetConfigInt( NetConfig type )
	{
		...
		var result =
			Internal.GetConfigValue( type, NetConfigScope.Global, IntPtr.Zero, ref dtype, (IntPtr)ptr, ref size );
