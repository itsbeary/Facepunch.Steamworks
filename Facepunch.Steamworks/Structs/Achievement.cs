...
public struct Achievement
{
	...
	/// <summary>
	///     If <see cref="State" /> is <see langword="true" />, this value represents the time that the achievement was
	///     unlocked.
	/// </summary>
	...
	///     hasn't been downloaded by Steam yet. You should use <see cref="GetIconAsync(int)" /> if you want to wait for the
	...
	/// <summary>
	///     Gets the icon of the achievement, yielding until the icon is received or the <paramref name="timeout" /> is
	///     reached.
	/// </summary>
	...
	/// <summary>
	///     Gets a decimal (0-1) representing the global amount of users who have unlocked the specified achievement, or -1 if
	///     no data available.
	/// </summary>
