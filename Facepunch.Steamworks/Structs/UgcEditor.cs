...
public struct Editor
{
	...
	private readonly bool creatingNew;
	private readonly WorkshopFileType creatingType;
	...
	public Editor WithContent( string folderName ) { return WithContent( new DirectoryInfo( folderName ) ); }
