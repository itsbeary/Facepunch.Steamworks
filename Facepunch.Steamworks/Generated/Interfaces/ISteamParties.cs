...
internal class ISteamParties : SteamInterface
{
		...
		ref SteamPartyBeaconLocation_t pLocation, out string pchMetadata )
	{
		...
		var returnValue = _GetBeaconDetails( Self, ulBeaconID, ref pSteamIDBeaconOwner, ref pLocation, mem__pchMetadata,
			1024 * 32 );
	...
	[DllImport( Platform.LibraryName, EntryPoint = "SteamAPI_ISteamParties_GetAvailableBeaconLocations",
		CallingConvention = Platform.CC )]
	[return: MarshalAs( UnmanagedType.I1 )]
	private static extern bool _GetAvailableBeaconLocations( IntPtr self, ref SteamPartyBeaconLocation_t pLocationList,
	...
	private static extern SteamAPICall_t _CreateBeacon( IntPtr self, uint unOpenSlots,
		ref SteamPartyBeaconLocation_t pBeaconLocation, IntPtr pchConnectString, IntPtr pchMetadata );

	#endregion

	internal CallResult<CreateBeaconCallback_t> CreateBeacon( uint unOpenSlots, /* ref */
		SteamPartyBeaconLocation_t pBeaconLocation, string pchConnectString, string pchMetadata )
	{
		...
		var returnValue = _CreateBeacon( Self, unOpenSlots, ref pBeaconLocation, str__pchConnectString.Pointer,
			str__pchMetadata.Pointer );
	...
	internal bool GetBeaconLocationData( SteamPartyBeaconLocation_t BeaconLocation, SteamPartyBeaconLocationData eData,
