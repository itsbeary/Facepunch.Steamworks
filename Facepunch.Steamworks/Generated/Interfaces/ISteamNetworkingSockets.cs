...
internal unsafe class ISteamNetworkingSockets : SteamInterface
{
	...
	[DllImport( Platform.LibraryName, EntryPoint = "SteamAPI_ISteamNetworkingSockets_ConnectP2P",
		CallingConvention = Platform.CC )]
	private static extern Connection _ConnectP2P( IntPtr self, ref NetIdentity identityRemote, int nRemoteVirtualPort,
	...
	private static extern bool _CloseConnection( IntPtr self, Connection hPeer, int nReason, IntPtr pszDebug,
		[MarshalAs( UnmanagedType.U1 )] bool bEnableLinger );

	#endregion

	internal bool CloseConnection( Connection hPeer, int nReason, string pszDebug,
		[MarshalAs( UnmanagedType.U1 )] bool bEnableLinger )
	{
	...
	internal Connection ConnectP2PCustomSignaling( IntPtr pSignaling, ref NetIdentity pPeerIdentity,
		int nRemoteVirtualPort, int nOptions, [In] [Out] NetKeyValue[] pOptions )
	{
		var returnValue = _ConnectP2PCustomSignaling( Self, pSignaling, ref pPeerIdentity, nRemoteVirtualPort, nOptions,
			pOptions );
		return returnValue;
	}
