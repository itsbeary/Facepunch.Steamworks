...
internal partial struct gameserveritem_t
{
	...
	{
		return Utility.Utf8NoBom.GetString( GameDir, 0, Array.IndexOf<byte>( GameDir, 0 ) );
	}
	...
	{
		return Utility.Utf8NoBom.GetString( Map, 0, Array.IndexOf<byte>( Map, 0 ) );
	}
	...
	{
		return Utility.Utf8NoBom.GetString( GameDescription, 0, Array.IndexOf<byte>( GameDescription, 0 ) );
	}
	...
	{
		return Utility.Utf8NoBom.GetString( ServerName, 0, Array.IndexOf<byte>( ServerName, 0 ) );
	}
	...
	{
		return Utility.Utf8NoBom.GetString( GameTags, 0, Array.IndexOf<byte>( GameTags, 0 ) );
	}
...
internal partial struct SteamDatagramHostedAddress
{
	...
	{
		return Utility.Utf8NoBom.GetString( Data, 0, Array.IndexOf<byte>( Data, 0 ) );
	}
...
internal struct SteamDatagramGameCoordinatorServerLogin
{
	...
	{
		return Utility.Utf8NoBom.GetString( AppData, 0, Array.IndexOf<byte>( AppData, 0 ) );
	}
