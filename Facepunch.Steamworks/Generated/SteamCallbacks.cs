...
internal struct GameWebCallback_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( URL, 0, Array.IndexOf<byte>( URL, 0 ) );
	}
...
internal struct GameOverlayActivated_t : ICallbackData
{
	...
	[MarshalAs( UnmanagedType.I1 )] internal bool UserInitiated; // m_bUserInitiated bool
...
internal struct GameServerChangeRequested_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( Server, 0, Array.IndexOf<byte>( Server, 0 ) );
	}
	...
	{
		return Utility.Utf8NoBom.GetString( Password, 0, Array.IndexOf<byte>( Password, 0 ) );
	}
...
internal struct GameRichPresenceJoinRequested_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( Connect, 0, Array.IndexOf<byte>( Connect, 0 ) );
	}
...
internal struct OverlayBrowserProtocolNavigation_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( RgchURI, 0, Array.IndexOf<byte>( RgchURI, 0 ) );
	}
...
internal struct EquippedProfileItems_t : ICallbackData
{
	...
	[MarshalAs( UnmanagedType.I1 )] internal bool FromCache; // m_bFromCache bool
...
internal struct JoinPartyCallback_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( ConnectString, 0, Array.IndexOf<byte>( ConnectString, 0 ) );
	}
...
internal struct RemoteStorageFileShareResult_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( Filename, 0, Array.IndexOf<byte>( Filename, 0 ) );
	}
...
internal struct RemoteStorageDownloadUGCResult_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( PchFileName, 0, Array.IndexOf<byte>( PchFileName, 0 ) );
	}
...
internal struct RemoteStorageGetPublishedFileDetailsResult_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( Title, 0, Array.IndexOf<byte>( Title, 0 ) );
	}
	...
	{
		return Utility.Utf8NoBom.GetString( Description, 0, Array.IndexOf<byte>( Description, 0 ) );
	}
	...
	{
		return Utility.Utf8NoBom.GetString( Tags, 0, Array.IndexOf<byte>( Tags, 0 ) );
	}
...
internal struct UserAchievementStored_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( AchievementName, 0, Array.IndexOf<byte>( AchievementName, 0 ) );
	}
...
internal struct AppProofOfPurchaseKeyResponse_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( Key, 0, Array.IndexOf<byte>( Key, 0 ) );
	}
...
internal struct SteamUGCQueryCompleted_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( NextCursor, 0, Array.IndexOf<byte>( NextCursor, 0 ) );
	}
...
internal struct SteamInventoryRequestPricesResult_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( Currency, 0, Array.IndexOf<byte>( Currency, 0 ) );
	}
...
internal struct SteamTimelineGamePhaseRecordingExists_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( PhaseID, 0, Array.IndexOf<byte>( PhaseID, 0 ) );
	}
...
internal struct SteamTimelineEventRecordingExists_t : ICallbackData
{
	...
	[MarshalAs( UnmanagedType.I1 )] internal bool RecordingExists; // m_bRecordingExists bool
...
{
	[MarshalAs( UnmanagedType.I1 )] internal bool IsRTMP; // m_bIsRTMP bool
...
internal struct SteamRemotePlayTogetherGuestInvite_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( ConnectURL, 0, Array.IndexOf<byte>( ConnectURL, 0 ) );
	}
...
internal struct SteamNetAuthenticationStatus_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( DebugMsg, 0, Array.IndexOf<byte>( DebugMsg, 0 ) );
	}
...
internal struct GSClientDeny_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( OptionalText, 0, Array.IndexOf<byte>( OptionalText, 0 ) );
	}
...
internal struct GSClientAchievementStatus_t : ICallbackData
{
	...
	{
		return Utility.Utf8NoBom.GetString( PchAchievement, 0, Array.IndexOf<byte>( PchAchievement, 0 ) );
	}
