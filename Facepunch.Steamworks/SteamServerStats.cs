...
public class SteamServerStats : SteamServerClass<SteamServerStats>
{
	...
	///     <paramref name="defaultValue" />. You should have called <see cref="RequestUserStatsAsync(SteamId)" /> for this
	///     SteamID - which downloads
	...
	/// <summary>
	///     Unlocks the specified achievement for the specified user. Must have called
	///     <see cref="RequestUserStatsAsync(SteamId)" /> on a SteamID first.
	...
	/// <summary>
	///     Resets the unlock status of an achievement for the specified user. Must have called
	///     <see cref="RequestUserStatsAsync(SteamId)" /> on a SteamID first.
	///     Remember to use <see cref="StoreUserStats(SteamId)" /> after use.
	/// </summary>
