...
{
	private readonly SteamAPICall_t call;
	private readonly ISteamUtils utils;
	...
	public T? GetResult()
	{
		...
		try
		{
			...
			Dispatch.OnDebugCallback?.Invoke( t.CallbackType, Dispatch.CallbackToString( t.CallbackType, ptr, size ),
				server );
