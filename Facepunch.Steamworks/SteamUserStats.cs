...
public class SteamUserStats : SteamClientClass<SteamUserStats>
{
	...
	/// </summary>
	/// <param name="days">
	///     How many days of day-by-day history to retrieve in addition to the overall totals. The limit is
	///     <c>60</c>.
	/// </param>
	/// <returns>
	///     <see cref="Result.OK" /> indicates success, <see cref="Result.InvalidState" /> means you need to call
	///     <see cref="RequestCurrentStats" /> first, <see cref="Result.Fail" /> means the remote call failed
	/// </returns>
	...
	/// <summary>
	///     Practically wipes the slate clean for this user. If <paramref name="includeAchievements" /> is
	///     <see langword="true" />, will also wipe
