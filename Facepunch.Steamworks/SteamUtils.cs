...
public class SteamUtils : SteamSharedClass<SteamUtils>
{
	...
	///     <para>
	///         If this is set to <see langword="true" />, then the scene in the HMD headset will be streamed, and remote input
	///         will not be allowed.
	///         If this is set to <see langword="false" />, then the application window will be streamed instead, and remote
	...
	/// <summary>
	///     Gets whether this steam client is a Steam China specific client (<see langword="true" />), or the global client (
	///     <see langword="false" />).
	/// </summary>
	...
	/// <summary>
	///     Invoked when Big Picture gamepad text input has been closed. Parameter is <see langword="true" /> if text was
	///     submitted, <see langword="false" /> if cancelled etc.
	/// </summary>
	...
	{
		return Internal.InitFilterText( 0 );
	}
